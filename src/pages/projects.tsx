...
const projects = [
  { key: 'rumbla', img: rumblaImg },
  { key: 'vikinor', img: vikinorImg },
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-24 px-6 bg-secondary text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.p
          ...
          className="max-w-2xl mx-auto text-textSecondary mb-14 text-base md:text-lg"
        >
          {t(
            'projects.subtitle',
            'A selection of digital products, brands and experiences I have worked on across design, development and strategy.'
          )}
        </motion.p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map(({ key, img }, index) => (
            <motion.article
              key={key}
              className="text-left group bg-card rounded-2xl border border-slate-800 overflow-hidden shadow-xl hover:-translate-y-1 transition-all duration-300"
